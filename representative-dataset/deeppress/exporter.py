...
class TF2LiteConverter():
    ...
    def export_graph(self):
        ...
        command = [
            ...
            '--pipeline_config_path={}'.format(self.job['pipeline_config_path']),
            '--trained_checkpoint_dir={}'.format(self.trained_checkpoint_dir),
            '--output_directory={}'.format(self.job['exportedGraphDir']),
            '--max_detections=20',
