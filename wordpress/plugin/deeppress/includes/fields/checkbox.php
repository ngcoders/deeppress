...
class dp_field_checkbox extends dp_field
{
	...
	*/
	...
	function create_field( $field )
	{
		...
		$e .= '<ul class="ba-checkbox-list ' . esc_attr($field['class']) . ' ' . esc_attr($field['layout']) . '">';
