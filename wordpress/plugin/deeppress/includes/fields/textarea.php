...
class dp_field_textarea extends dp_field
{
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Rows",'ba'); ?></label>
		<p><?php _e("Sets the textarea height",'ba') ?></p>
	</td>
	<td>
		<?php 
		do_action('dp/create_field', array(
	...
	<td>
		...
		do_action('dp/create_field', array(
			...
			'choices' => array(
				...
				'br'	=>	__("Convert new lines into &lt;br /&gt; tags",'ba'),
