...
class dp_field_true_false extends dp_field
{
	...
	*/
	...
	{
		// html
		echo '<ul class="ba-checkbox-list ' . $field['class'] . '">';
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Message",'ba'); ?></label>
		<p class="description"><?php _e("eg. Show extra content",'ba'); ?></a></p>
	</td>
	<td>
		<?php 
